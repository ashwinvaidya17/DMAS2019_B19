...
end_of_games = int(input("Choose total number of games (eg: 5): "))
end_of_rounds = int(input("Choose number of rounds in a game (eg: 15): "))

# The Game will begins after 2 Seconds
print("\nGame begins in:")
time.sleep(0.5)
...
rps.rock_paper_scissor(player_1_order, player_2_order, end_of_games, end_of_rounds)
